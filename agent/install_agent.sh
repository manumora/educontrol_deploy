...
echo -e "   ${YELLOW}include educontrol_agent${NC}"
echo ""
echo "2. Reinicia el servidor Puppet para que cargue el nuevo módulo:"
echo -e "   ${YELLOW}systemctl restart puppetserver${NC}"
echo ""
echo "3. Aplica los cambios en el cliente Puppet:"
echo -e "   ${YELLOW}puppet agent -t${NC}"
echo ""
echo "4. Verifica los logs si hay algún problema:"
echo -e "   ${YELLOW}puppet agent -t --debug${NC}"
echo ""
echo "=========================================="
echo ""
